...
## 【待辦，等使用者跟同仁確認】人資代傳各所加退保 ＋ 新增「蝦皮」部門（2026-09-23 提出，尚未動工）
...
## 【待辦，規格討論中、等使用者說「請實作」】配送部按報到／離職自動進「每日加退保」暫存區（2026-09-24 提出）

**這一節是還沒做的需求**。使用者 2026-09-24 提出，確認到一半，還差下面「待確認」幾點。
...
- **身分證字號**：人資範本需要，但配送系統 2026-09-24 改版剛拿掉。選項：
  A 留空給人資補；B 只在報到／離職視窗填、只進加退保資料；C 人員資料恢復身分證欄位。
  （舊資料有身分證的都可以自動帶入）
- **收單後沒送出的暫存資料**：下載之後是清掉，還是留著隔天可以繼續送？
