...
## 【待辦計畫】業務開發整併：兩支爬蟲合一、搬進平台、改存 Firestore（2026-09-23 決定，尚未動工）

**這一節是計畫，不是已完成的事。** 2026-09-23 使用者說「我們來開一下業務
開發的功能」，盤點現況後決定把業務開發整個整併進材霈平台。實作還沒開始，
等使用者說「請實作」再從階段 1 動工，下次接手從這裡讀起。
