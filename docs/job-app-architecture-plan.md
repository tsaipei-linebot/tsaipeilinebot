...
2. **Phase 2 · 開放 SELF_SERVE（約 2 個月，分兩步）**：
   ...
   - **2b 開放外部商家**：驗證過後才開放真外部商家（收費），需搭配評價系統、Vertex AI 語意配對、金流/訂閱上線；**私立就業服務機構許可等法遵確認須在 2b 之前完成**（且 2a 是否也需要確認，見 `job-app-handoff.md` 法遵風險備註）
3. **Phase 3 · 規模化（約 2–3 個月）**：原生 App、ATS 拖拉看板、企業品牌頁、數據儀表板、內容社群、Learning-to-Rank
4. **Phase 4 · 擴張**：多語言、跨區域擴展（含越南）、企業 API 開放、與外部 HR 系統整合
