...
def insurance_uploads_ref():
    return get_db().collection(INSURANCE_UPLOADS_COLLECTION)


def insurance_day_locks_ref():
    return get_db().collection(INSURANCE_DAY_LOCKS_COLLECTION)
